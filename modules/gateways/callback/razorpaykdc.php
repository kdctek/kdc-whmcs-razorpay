...
if ($success === true) {
    ...
    $razorpay_fees = (empty($response_array['fees']) ? 0 : $response_array['fees'];
    addInvoicePayment($merchant_order_id, $razorpay_payment_id, $amount, $razorpay_fees, $gatewayParams["name"]);
